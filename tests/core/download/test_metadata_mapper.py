...
class MetadataMapperTests(unittest.TestCase):
    def test_selected_audio_bitrate_uses_ytdlp_abr(self):
        info = {
            "requested_formats": [
                {"vcodec": "h264", "acodec": "none", "abr": None},
                {"vcodec": "none", "acodec": "opus", "abr": 136.515},
            ],
        }
    ...
    def test_audio_only_selection_contains_no_phantom_video_stream(self):
        streams = selected_download_streams(
            {
                "format_id": "251",
                "vcodec": "none",
                "acodec": "opus",
        ...
        self.assertEqual(
            streams,
            [{"id": "251", "kind": "audio", "size": 50}],
        )

    def test_combined_selection_is_one_stream(self):
        streams = selected_download_streams(
            {
                "format_id": "18",
                "vcodec": "h264",
